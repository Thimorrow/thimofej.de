  ...
  return (
    <main className="page-wrap">
      ...
      <section className="content-section note-section" aria-labelledby="more-title">
        ...
        <p>You can find me on <LinkText href="https://x.com/thimorrowr">X</LinkText> and <LinkText href="https://github.com/thimorrowr">GitHub</LinkText>, see more of my work in <LinkText href="#projects">my projects</LinkText>, and read more of my thinking in <LinkText href="#writing">my notes</LinkText>.</p>
      </section>
